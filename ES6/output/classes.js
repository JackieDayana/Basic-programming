...
var jackie = new Usuario('Jackeline', 27, 'jackiedayana@gmail.com'); //document.write(jackie.mostrarSaludo('HolaaaaaaAAA'));

document.write(jackie.mostrarInfo()); // Herencia
...
var kevin = new Estudiante('Kevin', 26, 'kevinvelasco@gmail.com', 'Desarrollador Web');
